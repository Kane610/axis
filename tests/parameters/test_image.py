...
IMAGE_RESPONSE = """root.Audio.DSCP=0
...
@respx.mock
async def test_update_image(image_handler: ImageParameterHandler):
    ...
    assert image_handler["0"].enabled is True
    assert image_handler["0"].name == "View Area 1"
    assert image_handler["0"].source == 0
    assert image_handler["0"].appearance == {
        "ColorEnabled": True,
        "Compression": 30,
        "MirrorEnabled": False,
    ...
    assert image_handler["0"].overlay == {
        "Enabled": False,
        "XPos": 0,
        "YPos": 0,
        "MaskWindows": {"Color": "black"},
    }
    assert image_handler["0"].rate_control == {
        "MaxBitrate": 0,
        "Mode": "vbr",
        "Priority": "framerate",
        "TargetBitrate": 0,
    }
    assert image_handler["0"].size_control == {"MaxFrameSize": 0}
    assert image_handler["0"].stream == {
        "Duration": 0,
        "FPS": 0,
        "NbrOfFrames": 0,
    }
    assert image_handler["0"].text == {
        "BGColor": "black",
        "ClockEnabled": False,
        "Color": "white",
        "DateEnabled": False,
    ...
    assert image_handler["0"].trigger_data == {
        "AudioEnabled": True,
    ...
    assert image_handler["1"].enabled is False
    assert image_handler["1"].name == "View Area 2"
    assert image_handler["1"].source == 0
    assert image_handler["1"].appearance == {
        "ColorEnabled": True,
        "Compression": 30,
        "MirrorEnabled": False,
        "Resolution": "1920x1080",
    ...
    assert image_handler["1"].overlay == {"Enabled": False, "XPos": 0, "YPos": 0}
    assert image_handler["1"].rate_control == {
        "MaxBitrate": 0,
        "Mode": "vbr",
        "Priority": "framerate",
        "TargetBitrate": 0,
    }
    assert image_handler["1"].size_control == {"MaxFrameSize": 0}
    assert image_handler["1"].stream == {
        "Duration": 0,
        "FPS": 0,
        "NbrOfFrames": 0,
    }
    assert image_handler["1"].text == {
        "BGColor": "black",
        "ClockEnabled": False,
        "Color": "white",
        "DateEnabled": False,
    ...
    assert image_handler["1"].trigger_data == {
        "AudioEnabled": True,
        "MotionDetectionEnabled": True,
        "MotionLevelEnabled": False,
        "TamperingEnabled": True,
