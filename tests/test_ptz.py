...
async def test_ptz_control_no_input(ptz_control):
    ...
    route = respx.get("http://host:80/axis-cgi/com/ptz.cgi")
...
async def test_ptz_control_camera_with_move(ptz_control):
    ...
    route = respx.post("http://host:80/axis-cgi/com/ptz.cgi")
...
async def test_query_limit(ptz_control):
    ...
    route = respx.post("http://host:80/axis-cgi/com/ptz.cgi").respond(
        text="""MinPan=-170
MaxPan=170
MinTilt=-20
MaxTilt=90
